...
<div class="container body">
                        ...
                        <div class="x_content">
                            ...
                            if(isset($_GET['obra_id']) && $_GET['obra_id']){
                                if(count($comites) <= 0){
                                    echo "<div class=\"animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12\">
                                            <div class=\"tile-stats\">
                                                ...
                                                <p><span class='label label-info'>Nuevo</span></p>
                                                <br/>                                                
                                                <h3>{$obra['num_obra']}-001</h3>                                                
                                                <p title='{$obra['num_obra']}' style='white-space: nowrap;overflow: hidden;text-overflow: ellipsis;'>{$obra['nombre_obra']}</p>
                                                <br/>";
                                    echo "<p><i class='fa fa-calendar-times-o'></i> Sin agendar</p>";
                                    echo "<p><i class='fa fa-user-times'></i> Sin asignar</p>";
                                    echo "<p><i class='fa fa-user-times'></i> Sin responsable</p>";
                                    ...
                                    echo "<hr/>
                                                <p style='text-align: right'>                                                    
                                                    <a href='./procesar_nuevo_comite.php?obra_id={$obra['id_obra']}' title='Crear Comité' class='btn btn-primary'><i class='fa fa-users'></i> Crear Comité</a>                                                    
                                                </p>                                                
                                            </div>                                            
                                        </div>";
                                }
                                ...
                                foreach($comites as $comite){
                                   ...
                                   echo "<br/>                                                
                                                <h3 data-id='{$comite['id_comite']}' data-toggle='modal' data-target='#modalComiteTimeline' class='btnComiteTimeline'>{$comite['num_comite']}</h3>                                                
                                    ...
                                    if(isset($comite['usuario_id']) && $comite['usuario_id']){
                                        ...
                                        echo "<p><i class='fa fa-user-times'></i> Sin asignado de la Contraloría</p>";
                                    }
                            ...
                            if($sesion->usuario_adminsitrador_x_contraloriasocial){
                                        echo "<hr/>
                                                <p style='text-align: right'>";
                                        if($comite['status'] != 'confirmado') {
                                            echo "<a href='./agendar.php?comite_id={$comite['id_comite']}' title='Agendar' class='btn btn-primary' style='background-color:#27B89B; border: 1px solid #24B28A;'><i class='fa fa-calendar'></i> </a>";
                                        }
                                        else{
                                            echo "<a  title='Agendar' class='btn btn-disabled' ><i class='fa fa-calendar'></i> </a>";
                                        }
                                        if($comite['status'] != 'confirmado') {
                                            echo "<button id='{$comite['id_comite']}' title='Asignar' class='btnAsignar btn btn-info'><i class='fa fa-user'></i> </button>";
                                        }
                                        else{
                                            echo "<button title='Asignar' class='btn btn-disabled'><i class='fa fa-user'></i> </button>";
                                        }
                                        if($comite['status'] != 'confirmado') {
                                            echo "<a onclick='if(confirm(\"¿Estás seguro que deseas eliminar este comité?\")) window.location.href = \"./procesar_eliminar_comite.php?comite_id={$comite['id_comite']}\"; return false;' href='#' title='Eliminar Comité' class='btn btn-danger'><i class='fa fa-trash'></i> </a>";
                                        }
                                        else{
                                            echo "<a  title='Eliminar Comité' class='btn btn-disabled'><i class='fa fa-trash'></i> </a>";
                                        }
                                            echo"</p>";
                                        }
                                echo "</div>                                            
                            ...
                            if(count($comites) > 0){
                                echo "
                                        <div class='animated flipInY col-lg-3 col-md-3 col-sm-6 col-xs-12'>
                                            <a href='./procesar_nuevo_comite.php?obra_id={$obra['id_obra']}'>
                                            <div class='tile-stats' style='background-color: #EEE;'>
                                                    <div class=\"icon\"><i class=\"fa fa-users\"></i></div>
                                                    <br/><br/><br/><br/><br/><br/>
                                                    <p style='text-align: center'><i style='font-size: 32px' class='fa fa-plus'></i></p>
                                                    <p style='text-align: center'>Agregar Comité</p>
                                                    <br/><br/><br/><br/><br/><br/>
                                            </div>
                                            </a>
                                        </div>
                            ...
                            <div id="vistaComitesList" style="display:none">
                                    ...
                                    if(count($comites) <= 0){
                                        echo "<div class=\"animated flipInY col-lg-12 col-md-12 col-sm-12 col-xs-12\">
                                            <div class='tile-stats' style='padding: 10px;'>                                                                                                                                                                                                
                                                <span style='float: right' class='label label-info'>Nuevo</span>
                                                <h4 style='display: inline'><i class='fa fa-user'></i> {$obra['num_obra']}-001 </h4>                                                                                                
                                                <p title='{$obra['num_obra']}' style='white-space: nowrap;overflow: hidden;text-overflow: ellipsis;'>{$obra['nombre_obra']}</p>
                                                ";
                                        echo "<p style='text-align: right'>                                                    
                                                    <a href='./procesar_nuevo_comite.php?obra_id={$obra['id_obra']}' title='Crear Comité' class='btn btn-sm btn-primary'><i class='fa fa-users'></i> Crear Comité</a>                                                    
                                                </p>                                                
                                            </div>                                            
                                        </div>";
                                    }
                                ...
                                foreach($comites as $comite){
                                    ...
                                    switch($comite['status']){
                                        ...
                                        case 'confirmado': echo "<p><span style='float: right' class='label label-primary'><i class='fa fa-user'></i> Confirmado por la Contraloría </span></p>"; break;
                                        default: echo "<p><span class='label label-default'><i class='fa fa-question'></i> No definido </span></p>"; break;
                                    }

                                    echo "<h4  data-id='{$comite['id_comite']}' class='btnComiteTimeline' style='display: inline'><i class='fa fa-user'></i> {$comite['num_comite']}</h4>                                                                                                
                                                <p title='{$comite['obra']['nombre_obra']}' style='white-space: nowrap;overflow: hidden;text-overflow: ellipsis;'>{$comite['obra']['nombre_obra']}</p>";
                                    $normatividad = $comitesobj->getNormatividad($comite['id_comite']);
                                    echo "<p>Normatividad: {$normatividad}</p><br/>";
                                        if($sesion->usuario_adminsitrador_x_contraloriasocial) {
                                            echo " <p style='text-align: right'>";
                                            if ($comite['status'] != 'confirmado') {
                                                echo "<a href='./agendar.php?comite_id={$comite['id_comite']}' title='Agendar' class='btn btn-sm btn-primary' style='background-color:#27B89B; border: 1px solid #24B28A;'><i class='fa fa-calendar'></i> </a>";
                                            } else {
                                                echo "<a title='Agendar' class='btn btn-sm btn-disabled' ><i class='fa fa-calendar'></i> </a>";
                                            }
                                            if ($comite['status'] != 'sin_agendar' && $comite['status'] != 'confirmado') {
                                                echo "<button id='{$comite['id_comite']}' title='Asignar' class='btnAsignar btn  btn-sm btn-info'><i class='fa fa-user'></i> </button>";
                                            } else {
                                                echo "<button title='Asignar' class='btn  btn-sm btn-disabled'><i class='fa fa-user'></i> </button>";
                                            }
                                            if ($comite['status'] != 'confirmado') {
                                                echo "<a onclick='if(confirm(\"¿Estás seguro que deseas eliminar este comité?\")) window.location.href = \"./procesar_eliminar_comite.php?comite_id={$comite['id_comite']}\"; return false;' href='#' title='Eliminar Comité' class='btn btn btn-sm btn-danger'><i class='fa fa-trash'></i> </a>";
                                            } else {
                                                echo "<a href='#' title='Eliminar Comité' class='btn btn btn-sm btn-disabled'><i class='fa fa-trash'></i> </a>";
                                            }
                                            echo "</p>";
                                        }
                                    echo "</div>                                            
                                ...
                                if(count($comites) > 0){
                                    echo "
                                        <div class='animated flipInY col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                                            <a href='./procesar_nuevo_comite.php?obra_id={$obra['id_obra']}'>
                                            <div class='tile-stats' style='background-color: #EEE; padding: 25px;'>
                                                    <div class=\"icon\"><i class=\"fa fa-users\"></i></div>
                                                    <p style='text-align: center; '><i style='font-size: 18px' class='fa fa-plus'></i> Agregar Comité</p>                                                                                                
                                            </div>
                                            </a>
                                        </div>
                                ";
                            ...
                            <div class="clearfix"></div>
                            <br/>
                            <p style="text-align: right"><a target="_blank" href="./imprimir_lista.php" class="btn btn-primary"><i class="fa fa-print"></i> Imprimir Lista</a></p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="formAsignar" class="form-horizontal form-label-left" method="post" action="./procesar_asignar.php">
                        ...
                        <div class="form-group">
                            <label  class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">Puesto del Representante de la D.N.:</label>
                            <div class="col-md-8 col-sm-8 col-xs-12">
    ...
    <div class="modal fade" id="modalPaseLista" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Pase de Lista</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
    ...
    <div class="modal fade" id="modalComiteTimeline" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="exampleModalLabel">Línea del tiempo del Comité</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" id="divComiteTimeline">
