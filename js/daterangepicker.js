        ...
        renderCalendar: function(side) {
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    if (calendar[row][col].format('YYYY-MM-DD') == this.startDate.format('DD-MM-YYYY'))
        ...
        calculateChosenLabel: function () {
            ...
            for (var range in this.ranges) {
              if (this.timePicker) {
                    ...
                    if (this.startDate.format('YYYY-MM-DD') == this.ranges[range][0].format('YYYY-MM-DD') && this.endDate.format('DD-MM-YYYY') == this.ranges[range][1].format('DD-MM-YYYY')) {
                        customRange = false;
                        this.chosenLabel = this.container.find('.ranges li:eq(' + i + ')').addClass('active').attr('data-range-key');
                        break;
                    }
